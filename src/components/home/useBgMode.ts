...
// событие "bg-change".
export type BgMode = "rain" | "space" | "both";
export const BG_MODES: BgMode[] = ["rain", "space", "both"];
export const DEFAULT_BG: BgMode = "both";

export function readBgMode(): BgMode {
  if (typeof window === "undefined") return DEFAULT_BG;
  const v = localStorage.getItem("bg");
  return v === "rain" || v === "space" || v === "both" ? v : DEFAULT_BG;
}
